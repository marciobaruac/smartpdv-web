...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form method="post" action="/produtoEcommerce/saveImagem" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
							...
							<div class="card card-custom gutter-b card-stretch">
								@if(file_exists(public_path('/ecommerce/produtos/').$g->path))
								<img style="width: auto; height: 200px;" src="/ecommerce/produtos/{{$g->img}}">
								@else
								<img style="width: auto; height: 200px;" src="/imgs/no_image.png" alt="image">
								@endif
								<a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/produtoEcommerce/deleteImagem/{{$g->id}}" }else{return false} })' href="#!" class="btn btn-danger">
