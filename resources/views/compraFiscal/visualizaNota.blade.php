				...
				<div class="col-lg-12">
												 ...
												 <!--	<td class="datatable-cell quantidade">
													...
													<th class="datatable-cell">
														<span style="width: 80px;">
															...
															<a id="th_acao2_{{$i['codigo']}}" @if($i['produtoNovo']) style="display: none" @else style="display: block" @endif onclick="editProd('{{$i['codigo']}}', '{{$i['vUnCom']}}','{{$i['vmargemcusto']}}' )" href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2">
					...
					<div class="col-xl-12">
						<div class="row">
							...
							@if($dadosNf['contSemRegistro'] == 0)
							   <div class="col-xl-3">
							     <button type="button" id="salvar-compra" class="btn btn-success font-weight-bold spinner-white spinner-right">Salvar Compra</button>
							   </div>
							@endif
						</div>
					</div>
...
<div class="modal fade" id="modal2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
      ...
      <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<!-- <button type="button" id="salvar-compra" class="btn btn-success font-weight-bold spinner-white spinner-right">Salvar</button>-->
