									...
									<div class="row">
										...
										<div class="form-group validated col-lg-2 col-md-2 col-sm-6">
											...
											<select class="custom-select form-control" id="sigla_uf" name="sigla_uf">
												...
												<option value="{{$key}}" @if($config !=null) @if(isset($cliente)) @if($key==$cliente->cidade->uf )
												   selected
												   @endif
												   @else
												   @if($key == $config->UF)
												...
												<div class="row">
													...
													<div class="form-group validated col-lg-6 col-md-6 col-sm-10">
														...
														<select class="form-control select2" id="kt_select2_1" name="cidade">
															...
															<option value="{{$c->id}}" @if(isset($cliente)) @if($c->id == $cliente->cidade_id)
																selected
																@endif
												                @else
																@if($cidade->id == $c->id) selected @endif
																@endif
