...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<label>
				Total de registros:
				{{ method_exists($apontamentos, 'total') ? $apontamentos->total() : count($apontamentos) }}
			</label>
			<div class="text-muted">Carregando por padrão os últimos 15 dias. Use o período para consultar datas maiores.</div>
			<div class="row">
