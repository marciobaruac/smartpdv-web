		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<div class="row">
                ...
                <div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Relatório Posição Atual do Estoque
							</h3>
						</div>
						...
						<div class="card-content">
							<div class="col-xl-12">
								<form method="get" action="/relatorios/filtroApontamento">
									<div class="row">
							...
							<div class="col-xl-12">
								<form method="get" action="/relatorios/filtroVendaProdutos">
									<div class="row">
										...
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left col-lg-12 col-sm-12">Clientes</label>

											<select class="form-control select2" id="kt_select2_3"  name="cliente">
												<option value="todos">Todos</option>
												@foreach($clientes as $c)

												@if($config->visualizaclientefantasia == 0)
                                        ...
                                        <div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left col-lg-12 col-sm-12">Categoria de Produtos</label>

											<select class="form-control select2" id="kt_select2_4"  name="categoriaproduto">
												<option value="todos">Todos</option>
				...
				<div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Relatório de Atendimento
							</h3>
						</div>
						...
						<div class="card-content">
							<div class="col-xl-12">
								<form method="get" action="/relatorios/relatorioAtendimento">
									<div class="row">
										...
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left col-lg-12 col-sm-12">Usuário/Garçom</label>
				...
				<div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Relatório de Despesas
							</h3>
						</div>
						...
						<div class="card-content">
							<div class="col-xl-12">
								<form method="get" action="/relatorios/filtroDespesas">
									<div class="row">
				...
				<div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Relatório de Receitas
							</h3>
						</div>
						...
						<div class="card-content">
							<div class="col-xl-12">
								<form method="get" action="/relatorios/filtroReceitas">
									<div class="row">
