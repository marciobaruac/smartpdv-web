		...
		<div class="container">
			<div class="card card-custom gutter-b example example-compact">
				<div class="col-lg-12">
					...
					<input type="hidden" value="{{json_encode($infos)}}" id="infos">
					...
					<div class="row">
						...
						<div class="col-xl-8">
							...
							<input type="hidden" value="{{$infos['nNf']}}" id="nf">
										...
										<table class="datatable-table" style="max-width: 100%;overflow: scroll">
											<thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
													...
													<th data-field="Type" data-autohide-disabled="false" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">Valor Venda</span></th>
													<th data-field="Type" data-autohide-disabled="false" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">% Margem Sobre Custo</span></th>
											...
											<tbody class="datatable-body">
												...
												<tr class="datatable-row" id="tr_{{$i['codigo']}}" style="left: 0px;">
													...
													<td style="display: none" class="datatable-cell"><span class="ncm" style="width: 80px;">{{$i['NCM']}}</span></td>
													<td class="datatable-cell"><span class="cfop" style="width: 80px;">{{$i['CFOP']}}</span></td>
													<td style="display: none" class="datatable-cell"><span class="codBarras" style="width: 90px;">{{$i['codBarras']}}</span></td>
													<td class="datatable-cell"><span class="unidade" style="width: 80px;">{{$i['uCom']}}</span></td>
													<td class="datatable-cell"><span class="valor_compra" style="width: 80px;">{{$i['vUnCom']}}</span></td>
													<td class="datatable-cell"><span class="quantidade" style="width: 80px;">{{$i['qCom']}}</span></td>
											
													<th class="cod" id="th_prod_id_{{$i['codigo']}}" style="display: none">{{$i['produtoId']}}
													...
													<td class="datatable-cell"><span class="quantidade" style="width: 80px;">{{number_format((float) $i['vvalorvenda'],2, ',','.')}}</span></td>
													 <!--<td class="datatable-cell"><span class="quantidade" style="width: 80px;">{{number_format((float) $i['vmargemcusto'],2,',','.')}}</span></td>-->
                                                    <td class="datatable-cell"><span class="quantidade" style="width: 80px;">{{ $i['vmargemcusto'] }} %</span></td>

                      								<th class="datatable-cell">
														<span style="width: 80px;">
															<a id="th_acao1_{{$i['codigo']}}" @if($i['produtoNovo']) style="display: block" @else style="display: none" @endif onclick="cadProd('{{$i['codigo']}}','{{$i['xProd']}}','{{$i['codBarras']}}','{{$i['NCM']}}','{{$i['CFOP']}}','{{$i['uCom']}}','{{$i['vUnCom']}}', '{{$i['qCom']}}', '{{$i['vUnCom']}}', '{{$infos['nNf']}}','{{$i['cst']}}','{{$config->CST_CSOSN_padrao}}','{{$i['cest']}}')" href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2">
															...
															<a id="th_acao2_{{$i['codigo']}}" @if($i['produtoNovo']) style="display: none" @else style="display: block" @endif onclick="editProd('{{$i['produtoId']}}','{{$i['vUnCom']}}','{{$i['vmargemcusto']}}')" href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2">
					...
					<div class="col-xl-12">
						...
						<div class="row">
							...
							<div class="col-xl-3">
								<a href="/dfe/imprimirDanfe/{{$infos['chave']}}" style="width: 100%" type="submit" class="btn btn-light-info">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<input style="display: none" id="cest" type="text" class="form-control" name="cest" value="">
				...
				<div class="row">
					<div class="form-group validated col-sm-6 col-lg-6">
						...
						<div class="">
							<input id="valor_compra" type="text" class="form-control" name="valor_compra" value="">
						</div>
					</div>
					<div class="form-group validated col-sm-6 col-lg-6">
				...
				<div class="row">
					<div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label">Margem Sobre Valor da Compra</label>
						<div class="">
							<input id="valor_margem" type="text" class="form-control" name="valor_margem" value="">
						</div>
					</div>
					<div class="form-group validated col-sm-6 col-lg-6">
...
<div class="modal fade" id="modal2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
      <input id="CodigoEdit" type="hidden" class="form-control" name="CodigoEdit" value="">   
      <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="row">
				    <div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label">Fator Conversão</label>
						<div class="">
				     ...
				     <div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label">Valor de Compra</label>
						<div class="">
							<input id="valor_compraEdit" type="text" class="form-control" name="valor_compraEdit" value="">
						</div>
					</div>
					
					<div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label">Margem Sobre o Custo(%)</label>
						<div class="">
							<input id="valor_margemcustoEdit" type="text" class="form-control" name="valor_margemcustoEdit" value="">
						</div>
					</div>
					...
					<div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label">Valor de Venda</label>
						<div class="">
							<input id="valor_vendaEdit" type="text" class="form-control" name="valor_vendaEdit" value="">
						</div>
					</div>
