	...
	<div class="card border-0 med-blog">
		...
		<div class="card-body border border-top-0">
			...
			<div class="row">
					...
					<tbody>
						...
						<div class="container">
							<p class="text-center">Nenhum item no seu carrinho
								<a href="/atendimento" class="btn btn-primary">
				...
				<a href="/atendimento" type="button" class="btn btn-primary btn-lg btn-block">
					<span class="fa fa-bars mr-2"></span>CARDÁPIO</strong>
				</a>
				@endif

				@if($pedido)
				<a onclick='swal("Atenção!", "Deseja finalizar este atendimento? não irá pedir mais nada?", "warning").then((sim) => {if(sim){ location.href="/atendimento/finalizar" }else{return false} })' type="button" href="#!" class="btn btn-success btn-lg btn-block @if(sizeof($pedido->itens) == 0) disabled @endif">
