						...
						<div class="col-xl-8">
							<div class="kt-section kt-section--first">
								...
								<div class="row">
									...
									<div class="col s2">
										<label>Exibir auto atendimento:</label>

										<div class="switch switch-outline switch-primary">
											<label class="">
												<input @if(isset($produto->auto_atendimento) && $produto->auto_atendimento) checked @endisset value="true" name="auto_atendimento" class="red-text" type="checkbox">
												<span class="lever"></span>
											</label>
										</div>
									</div>
