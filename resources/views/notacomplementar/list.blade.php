...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<br>
			<h4>Lista de Notas Complementares</h4>

			<a href="/notacomplementar/nova" class="btn btn-light-danger">
				<i class="la la-plus"></i>
			Nova Nota Complementar</a>
											...
											<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
												...
												<table class="datatable-table" style="max-width: 100%; overflow: scroll">
													...
													<tbody id="body" class="datatable-body">
														...
														$total = 0;
														?>
														@foreach($notacomplementars as $d)
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell"><span class="codigo" style="width: 200px;">{{$d->cliente->razao_social}}</span>
															</td>
															...
															<td>
																<div class="row">
																	<span style="width: 280px;">
																		...
																		<a class="btn btn-warning" onclick='swal("Atenção!", "Deseja editar?", "warning").then((sim) => {if(sim){ location.href="/notacomplementar/edit/{{$d->id}}" }else{return false} })' 
																			href="#!">
											...
											<div class="card card-custom gutter-b example example-compact">
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a target="_blank" style="width: 100%; margin-top: 5px;" href="/notacomplementar/imprimir/{{$d->id}}" class="btn btn-primary spinner-white spinner-right">
