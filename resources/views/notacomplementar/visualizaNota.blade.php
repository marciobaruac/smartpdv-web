					...
					<div class="row">
						...
						<div class="col-xl-12">
							<div class="row">
								...
								<div class="col-xl-12 col-sm-12 col-lg-12">
									...
									<div class="row">
										<div class="col-xl-12">
											<h5 class="text-success">Dados Atualizados do Emitente</h5>
										...
										<table class="datatable-table" style="max-width: 100%;overflow: scroll" id="tbl">
											<thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
													...
													<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">NCM</span></th>
						...
						<div class="col-xl-12">
							...
							<div class="row">
								...
								<div class="form-group validated col-lg-8 col-md-8 col-sm-12">
									<label class="col-form-label text-left col-lg-12 col-sm-12">Tipo Frete</label>
								...
								<div class="form-group validated col-lg-8 col-md-8 col-sm-12">
									<label class="col-form-label text-left col-lg-12 col-sm-12">Transportadora</label>
					...
					<div class="col-xl-12">
						<div class="row">
							<div class="col-xl-12">
								...
								<div class="col-xl-3">
									<button id="salvar-notacomplementar" style="width: 100%" type="submit" class="btn btn-success">
