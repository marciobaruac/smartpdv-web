...
<div class="card card-custom gutter-b">
	<div class="card-body">
		<h1 class="center-align">Visualizando Nota Complementar</h1>
		<h4 class="center-align">Nota Fiscal de Origem <strong class="grey-text">{{$notacomplementar->nNf}}</strong></h4>
		<h4 class="center-align">Chave de Entrada <strong class="grey-text">{{$notacomplementar->chave_nf_origem}}</strong></h4>
			...
			<div class="card-body">
				<div class="card-content">
					<div class="row">
						<div class="col s8">
							<h5>Fornecedor: 
								<strong>{{$notacomplementar->cliente->razao_social}}</strong>
							</h5>
						</div>
					...
					<div class="col-xl-12">
						...
						<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
							...
							<table class="datatable-table" style="max-width: 100%; overflow: scroll">
								...
								<input type="hidden" value="{{json_encode($notacomplementar->itens)}}" id="itens_dev">
		...
		<div class="card card-custom gutter-b">
			<div class="card-body">
				...
				<div class="row">
					<div class="col s4">
						<a style="width: 50%;" href="/devolucao/downloadXmlEntrada/{{$notacomplementar->id}}" class="btn btn-info" target="_blank">
...
<div class="modal fade" id="modal1" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<form method="post" action="/notacomplementar/saveItem">
