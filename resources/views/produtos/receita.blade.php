													...
													<table class="table table-separate table-head-custom table-checkable dataTable no-footer" role="grid" style="margin-left: 0px">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="kt_datatable1" rowspan="1" colspan="1" >QUANTIDADE/VLR UNITÁRIO</th>
												...
												<table class="table table-separate table-head-custom table-checkable dataTable no-footer" id="kt_datatable1" role="grid" aria-describedby="kt_datatable1_info" style="">
											        ...
											        ?> 
														...
														<tr role="row" class="odd">
															...
															<td class="sorting_1">{{$i->quantidade}} X {{$i->produto->valor_compra}}/{{$i->medida}}</td>
															<td nowrap="nowrap">
															...
															<?php 
															    $subtotal += $i->quantidade * $i->produto->valor_compra;
												            ?>
														</tr>
														@endforeach
													</tbody>
													...
													<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
													    <div class="card card-custom gutter-b example example-compact">
													        <div class="card-header">
													              ...
													              <div class="card-body">
													                   <h3 class="card-title">Total Custo: R$ <strong class="red-text">{{ number_format($subtotal, 2, ',', '.') }}</strong></h3>
