								...
								<div class="kt-section__body">
									...
									<div class="row">
										<div class="form-group validated col-sm-9 col-lg-9">
											...
											<div class="">
												<input id=nome type="text" class="form-control @if($errors->has('nome')) is-invalid @endif" name="nome" value="{{{ isset($produto) ? $produto->nome : old('nome') }}}">
												@if($errors->has('nome'))
									...
									<div class="row">
									    ...
									    <div class="form-group validated col-sm-3 col-lg-3">
											...
											<div class="">
											   <input type="text" id="valor_compra" class="form-control @if($errors->has('valor_compra')) is-invalid @endif money" name="valor_compra" value="{{{ isset($produto) ? $produto->custoprodutofabricado($produto->id) : old('valor_compra') }}}">
										...
										<div class="form-group validated col-sm-3 col-lg-3">
											...
											<div class="">
												<input type="text" id="valor_venda" class="form-control @if($errors->has('valor_venda')) is-invalid @endif money" name="valor_venda" value="{{{ isset($produto) ? $produto->valorTabelaPadrao() : old('valor_venda') }}}">
										...
										<div class="form-group validated col-sm-3 col-lg-3">
											<label class="col-form-label">Lucro Bruto</label>
											<div class="">
											<input type="text" name="lucro" id="flucro"  class="form-control" disabled>
										    </div>
										</div>
									...
									<div class="row">
										...
										<div class="row">
										   <div class="form-group validated col-sm-4 col-lg-4">
										      <label class="col-form-label">Referência 2</label>
											  <div class="">
											     <input type="text" class="form-control @if($errors->has('referencia2')) is-invalid @endif" name="referencia2" value="{{{ isset($produto) ? $produto->referencia2 : old('referencia2') }}}">
												 @if($errors->has('referencia2'))
												 <div class="invalid-feedback">
													{{ $errors->first('referencia2') }}
												</div>
												 @endif
											  </div>
										    </div>
											<div class="form-group validated col-sm-4 col-lg-4">
										      <label class="col-form-label">Referência 3</label>
											  <div class="">
											     <input type="text" class="form-control @if($errors->has('referencia3')) is-invalid @endif" name="referencia3" value="{{{ isset($produto) ? $produto->referencia3 : old('referencia3') }}}">
												 @if($errors->has('referencia3'))
												 <div class="invalid-feedback">
													{{ $errors->first('referencia3') }}
												</div>
												 @endif
											  </div>
										    </div>
											<div class="form-group validated col-sm-4 col-lg-4">
										      <label class="col-form-label">Referência 4</label>
											  <div class="">
											     <input type="text" class="form-control @if($errors->has('referencia4')) is-invalid @endif" name="referencia4" value="{{{ isset($produto) ? $produto->referencia4 : old('referencia4') }}}">
												 @if($errors->has('referencia4'))
												 <div class="invalid-feedback">
													{{ $errors->first('referencia4') }}
												</div>
												 @endif
											  </div>
										    </div>
