							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-3">
											<label class="col-form-label text-left col-lg-12 col-sm-12">Acesso Inicial PDV</label>
											<div class="col-6">
												<span class="switch switch-outline switch-primary">
													<label>
														<input id="acesso_inicial_pdv" @if(isset($usuario->acesso_inicial_pdv) && $usuario->acesso_inicial_pdv) checked @endisset
														name="acesso_inicial_pdv" type="checkbox" >
														<span></span>
													</label>
												</span>
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-3">
											<label class="checkbox">
												<input type="checkbox" @if(isset($usuario) && $usuario->acesso_cte) checked @endisset
												id="acesso_cte" name="acesso_cte" />
												<span></span>
												Acesso CTe
											</label>
										</div>
										<div class="form-group validated col-sm-6 col-lg-3">
											<label class="checkbox">
												<input type="checkbox" @if(isset($usuario) && $usuario->acesso_mdfe) checked @endisset
												id="acesso_mdfe" name="acesso_mdfe" />
												<span></span>
												Acesso MDFe
											</label>
										</div>
										...
										<div class="form-group validated col-sm-6 col-lg-3">
											<label class="checkbox">
												<input type="checkbox" @if(isset($usuario) && $usuario->acesso_cancelamento_venda) checked @endisset
												id="acesso_cancelamento_venda" name="acesso_cancelamento_venda" />
												<span></span>
												Acesso Cancelamento de Venda
											</label>
										</div>
