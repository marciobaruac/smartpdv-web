									...
									<form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
										...
										<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
											...
											<div class="row">
												...
												<div class="form-group validated col-sm-2 col-lg-2">
													<br>
													<a style="margin-top: 13px;" id="add-pag"  class="btn btn-success font-weight-bold text-uppercase px-9 py-4">
														Adicionar
													</a>
											...
											<div class="row">
												<div class="form-group validated col-sm-12 col-lg-12">
													...
													<div   id="kt_datatablefatura" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded fatura">
														...
														<a style="margin-top: 13px;" id="delete-parcelas" class="btn btn-primary font-weight-bold text-uppercase px-9 py-4" >
														    Excluir Parcelas
													    </a>
