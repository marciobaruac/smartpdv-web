		...
		<div class="card-body">
			...
			@endif
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                    <a target="_blank" href="/dfe/imprimirDanfe/{{$compra->chave}}" class="btn btn-light-primary" style="margin-right: 8px;">
                        <i class="la la-file"></i>
                        Visualizar DANFE (Espelho)
                    </a>
                    <a target="_blank" href="/compras/downloadXml/{{$compra->id}}" class="btn btn-light-success">
