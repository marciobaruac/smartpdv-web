								...
								<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
										...
										<ul class="navi navi-hover">
											...
											<!-- <li class="navi-item">
												<a onclick='swal("Atenção!", "Deseja cancelar este registro?", "warning").then((sim) => {if(sim){ location.href="/contasReceber/cancelar/{{ $c->id }}" }else{return false} })' href="#!" class="navi-link">
													<span class="navi-text">
					...
					<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
						<div class="card card-custom gutter-b example example-compact">
							<div class="card-header">
								...
								<div class="card-body">
									<h3 class="card-title">Valor a Recebido: <strong style="margin-left: 5px;"> R$ {{number_format($somaRecebido, 2, ',', '.') }}</strong></h3>

								</div>


							<!--	<div class="card-body">
									<h3 class="card-title">Dinheiro: <strong style="margin-left: 5px;"> R$ {{number_format($somaDinheiro, 2, ',', '.') }}</strong></h3>
