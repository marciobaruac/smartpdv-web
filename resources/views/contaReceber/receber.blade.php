									...
									<div class="row">
									    <div class="form-group validated col-sm-6 col-lg-6">
											...
											<div class="input-group date">
											   <input type="text" name="data_pagamento" class="form-control @if($errors->has('emissao')) is-invalid @endif" readonly value="{{{ isset($conta) ? \Carbon\Carbon::parse($conta->data_emissao)->format('d/m/Y') : old('emissao') }}}" id="kt_datepicker_3" />
										...
										<div class="form-group validated col-sm-6 col-lg-6">
											...
											<div class="">
												<input type="text" class="form-control @if($errors->has('valor')) is-invalid @endif money" name="valor" value="{{$conta->valor_integral}}">
												@if($errors->has('valor'))
