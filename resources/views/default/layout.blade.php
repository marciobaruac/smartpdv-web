...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div class="d-flex flex-column flex-root" >
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" style="overflow-y: auto;">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<button class="brand-toggle btn btn-sm px-0 btn-hide" id="kt_aside_toggle">
				...
				<div id="kt_header" class="header  header-fixed">
							...
							<div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
								<ul class="menu-nav ">
									...
									<!-- 	@if(getenv('DELIVERY'))
										...
										<li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
											<a class="label label-xl label-inline label-light-danger">
												Empresa: {{session('user_logged')['razao_social']}}
											</a>
										</li>
					...
					<div class="topbar">
						<div class="topbar-item">
							<a class="btn btn-light-success" href="/frenteCaixa">
		...
		@if(isset($contasPagarJs))
		<script type="text/javascript" src="/js/contaspagar.js"></script>
		@endif
		...
		@if(isset($notacomplementarJs))
		<script type="text/javascript" src="/js/notacomplementar.js"></script>
		@endif

		@if(isset($notacomplementarNF))
		<script type="text/javascript" src="/js/notacomplementarNF.js"></script>
		@endif
