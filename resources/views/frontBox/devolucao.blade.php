															...
															<tr class="datatable-row" style="left: 0px; @if($v->estado == 'REJEITADO') background: #ffcdd2; @elseif($v->estado == 'APROVADO') background: #a7ffeb; @endif">
																...
																<td class="datatable-cell">
																	<span class="codigo" style="width: 220px;">
																		...
																		<a class="btn btn-danger" href="#!" onclick="modalCancelarnaofiscal({{$v->id}})">
													...
													<div class="card-body">
														...
														<div class="row">
														   ...
														   @if($v->estado == 'APROVADO')
															...
															@else
															<a href="#!" style="width: 100%; margin-top: 5px;" onclick="modalCancelarnaofiscal({{$v->id}})" class="btn btn-danger">
																<i class="la la-trash"></i>
																Cancelar Venda
															</a>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAMENTO DE VENDA NFCE</h5>
			<!--	<button id="cancelar-subtituicao" type="button" class="btn btn-light-danger">
...
<div class="modal fade" id="modalcancelarnaofiscal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAMENTO DE VENDA</h5>
			<!--	<button id="cancelar-subtituicao" type="button" class="btn btn-light-danger">
					Cancelar por substituição
				</button>-->
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-12 col-lg-12 col-12">
						<label class="col-form-label" id="">Justificativa</label>
						<input type="text" placeholder="Justificativa" id="justificativanaofiscal" name="justificativanaofiscal" class="form-control" value="">
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<button type="button" id="btn_cancelar_nfce" onclick="cancelarnaofiscal()" class="btn btn-light-info font-weight-bold spinner-white spinner-right">Cancelar</button>
...
<div class="modal fade" id="modal2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAMENTO DE NFCe POR SUBSTITUIÇÃO</h5>
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-12 col-lg-12 col-12">
						<label class="col-form-label" id="">Justificativa</label>
						<input type="text" placeholder="Justificativa" id="justificativa2" name="justificativa2" class="form-control" value="">
					</div>

					<div class="form-group validated col-sm-12 col-lg-12 col-12">
						<label class="col-form-label" id="">Chave referência</label>
						<input type="text" placeholder="Chave referência" id="chaveRef" name="chaveRef" class="form-control" value="">
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Fechar</button>
				<button type="button" id="btn_cancelar_nfce2" onclick="cancelarSubstituicao()" class="btn btn-light-info font-weight-bold spinner-white spinner-right">Cancelar</button>
			</div>
		</div>
	</div>
</div>
