...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="dropdown dropdown-inline show" data-toggle="tooltip" title="" data-placement="left">
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 m-0 " style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-211px, 39px, 0px);" x-placement="bottom-end">
                                ...
                                <ul class="navi navi-hover">
                                    ...
                                    <li class="navi-item">
                                        <a data-toggle="modal" href="#!" data-target="#modal-clientenovo" onclick="novoCliente()" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="/tef/listagem" class="navi-link">
                                            <span class="navi-text">
                                                <span class="label label-xl label-inline label-light-success">Lista de TEFs</span>
                                            </span>
                                        </a>
                                    </li>


                                    @if($usuario->acesso_cancelamento_venda == 1)
                                    <li class="navi-item">
                                        <a href="/frenteCaixa/devolucao" class="navi-link">
                                            <span class="navi-text">
                                                <span class="label label-xl label-inline label-light-danger">Cancelamento</span>
                                            </span>
                                        </a>
                                    </li>
                                        <li class="navi-item">
                                        <a href="/frenteCaixa/fechamentos" class="navi-link">
                                            <span class="navi-text">
                                                <span class="label label-xl label-inline label-light-success">Lista de Caixas</span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="navi-item">
                                    <li class="navi-item">
                                        <a href="/sangriaCaixa/listasangrias" class="navi-link">
                                            <span class="navi-text">
                                                <span class="label label-xl label-inline label-light-danger"> Lista de Sangria</span>
                                            </span>
                                        </a>
                                    </li>
                                    </li>
                                    ...
                                    <li class="navi-item">
                                        <a data-toggle="modal" href="#!" data-target="#modalsenha" class="navi-link">
                                            <span class="navi-text">
                                                <span class="label label-xl label-inline label-light-primary">Alterar Senha</span>
                                            </span>
                                        </a>
                                    </li>
                                    @if($usuario->adm == 1)
                        ...
                        <div class="card-header">
                            <div class="row align-items-center" style="margin-top: 10px;">
                                <div class="form-group validated col-sm-6 col-lg-6 col-12 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select2" id="kt_select2_1" name="produto">
                                            ...
                                            <option value="{{$p->idprecoproduto}}">{{$p->nomelista}} - {{$p->nome}} ( {{$p->referenciatabela}}) - {{$p->valor}} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group validated col-sm-2 col-lg-2 col-5 col-sm-5">
                                    <div class="">
                                        <input id="valor_item" placeholder="Valor" type="text" class="form-control" name="valor" value="0.00" disabled>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-3 col-lg-3 col-6">
                                    ...
                                    <button onclick="setaDesconto()" style="margin-left: 4px; margin-top: -10px; display: none;" class="btn btn-link-primary">
                                        <i class="la la-edit"></i>
                                    </button>
                                </div>
                                <div class="col-sm-3 col-lg-3 col-6">
                                    <label>Acrescimo: R$ <strong id="valor_acrescimo">0,00</strong></label>
                                    <button onclick="setaAcresicmo()" style="margin-left: 4px; margin-top: -10px; display: none;" class="btn btn-link-primary">
                                        <i class="la la-edit"></i>
                                    </button>
                                </div>
                                ...
                                <div class="col-sm-4 col-lg-4 col-6" style="margin-top: -8px;">
                                    ...
                                    <select disabled class="custom-select form-control" id="lista_id" name="lista_id">
                                    ...
                                    <div class="card card-custom gutter-b example example-compact">
                                        <div class="card-header" style="height: 180px;">
                                            ...
                                            <h6 style="font-size: 12px;" class="text-danger" class="kt-widget__label">
                                                R$ {{number_format($p->valor, 2)}} - {{$p->nomelista}} ({{$p->quantidade_minima}})
                                            </h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group validated col-sm-7 col-lg-3 col-12 col-md-12">
                                    ...
                                    <a class="btn btn-secondary me-2" href="/pedidos">
                                        <i class="la la-arrow-left"></i> Retornar para Comanda
                                    </a>
        ...
        <div class="modal fade" id="modalsenha" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group validated col-sm-12 col-lg-12 col-12">
                                <label class="col-form-label" id="">Nova Senha</label>
                                <input autofocus type="password" type="text" placeholder="Nova Senha" id="novasenha" name="novasenha" class="form-control" value="">
                            </div>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button style="width: 100%" type="button" onclick="alterarSenha()" class="btn btn-success font-weight-bold">Confirma</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn-abrecaixa" type="button" onclick="abrirCaixa()" class="btn btn-light-success font-weight-bold">Abrir</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal-venda" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="t-troco" class="modal-title">FINALIZAR VENDA </h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group validated col-sm-4 col-lg-4 col-10">
                                <button class="btn btn-info" id="btn_nao_fiscal" onclick="finalizarVenda('nao_fiscal','impressao_pdv/')" style="height: 50px; width: 100%">
                                    PEDIDO
                                </button>
                            </div>
                            @endif
                            <div class="form-group validated col-sm-4 col-lg-4 col-10 @if($certificado == null) disabled @endif">
        ...
        <div class="modal fade" id="modal-vendacartao" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="t-troco" class="modal-title">FINALIZAR VENDA </h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group validated col-sm-4 col-lg-4 col-10 @if($certificado == null) disabled @endif">
                                <button class="btn btn-success" onclick="verificaCliente()" style="height: 50px; width: 100%" id="conclusaoBtnCPF">
                                    CONCLUIR
                                </button>
                            </div>

                            <div class="form-group validated col-sm-4 col-lg-4 col-10 @if($certificado == null) disabled @endif">
                                <button class="btn btn-success" onclick="verificaClientecnpj()" style="height: 50px; width: 100%" id="conclusaoBtnCNPJ">
                                    CONCLUIR CNPJ
                                </button>
                            </div>
        ...
        <div class="modal fade" id="modal-vendad" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="t-troco" class="modal-title">FINALIZAR VENDA (Troco:) <strong class="text-danger" id="v-troco"></strong></h5>
        ...
        <div class="modal fade" id="modal-cnpj-nota" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">CNPJ NA NOTA?</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            x
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group validated col-sm-12 col-lg-12 col-12">
                                <label class="col-form-label" id="">CNPJ</label>
                                <input type="text" placeholder="CNPJ" id="cnpj" name="cnpj" class="form-control" value="">
                            </div>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button style="width: 100%" id="btn-cnpj" type="button" onclick="finalizarVendaCNPJ('fiscal')" class="btn btn-success font-weight-bold spinner-white spinner-right">EMITIR</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="height: 350px; overflow-y: auto;">
                            ...
                            <div class="col-sm-12 col-lg-12 col-12">
                                <h5>Total em caixa:
                                    <strong id="total_caixa" class="text-success"></strong>
                                </h5>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button autofocus id=btfechartroco type="button" class="close" data-dismiss="modal" aria-label="Close">
                        x
                    </button>
                </div>
    ...
    <div class="modal fade" id="modal-cartao1" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <form id="formCartao">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group validated col-sm-3 col-lg-3 col-6">
                                ...
                                <select class="custom-select" id="bandeira_cartao1" name="bandeira_cartao1">
                                    <option value=""></option>
                    ...
                    <div class="modal-footer">
                        <button style="width: 100%" id='salvar-cartao1' type="button" data-dismiss="modal" class="btn btn-success font-weight-bold">Salvar</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="modal fade" id="modal-cartao2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <form id="formCartao">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group validated col-sm-3 col-lg-3 col-6">
                                <label class="col-form-label">Bandeira</label>
                                <select class="custom-select" id="bandeira_cartao2" name="bandeira_cartao2">
                                    <option value=""></option>
                                    @foreach(App\Models\VendaCaixa::bandeiras() as $key => $b)
                                    <option value="{{$key}}">{{$b}}</option>
                                    @endforeach
                    ...
                    <div class="modal-footer">
                        <button style="width: 100%" id='salvar-cartao2' type="button" data-dismiss="modal" class="btn btn-success font-weight-bold">Salvar</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="modal fade" id="modal-cartao3" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <form id="formCartao">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group validated col-sm-3 col-lg-3 col-6">
                                <label class="col-form-label">Bandeira</label>
                                <select class="custom-select" id="bandeira_cartao3" name="bandeira_cartao3">
                                    <option value=""></option>
                                    @foreach(App\Models\VendaCaixa::bandeiras() as $key => $b)
                                    <option value="{{$key}}">{{$b}}</option>
                                    @endforeach
                    ...
                    <div class="modal-footer">
                        <button style="width: 100%" id='salvar-cartao3' type="button" data-dismiss="modal" class="btn btn-success font-weight-bold">Salvar</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="modal-fechamento" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addUsuarioModalLabel">Escolher forma de Pagamento</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        x
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select autofocus class="custom-select form-control" id="tipo-pagamento" name="tipo-pagamento">
                            <option value="">Selecione o Tipo de pagamento</option>
                            @foreach($tiposPagamento as $key => $t)
                            <option
                                @if($config->tipo_pagamento_padrao == $key)
                    ...
                    <div class="form-group row" style="display: none;" id="divParcelasCredTEF">
                        <input type="text" placeholder="Parcelas" id="parcel_cred" name="parcel_cred" class="form-control" value="1" readonly style="background-color: #f0f0f0; color: #000;">
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="custom-select" id="bandeira_cartao" name="bandeira_cartao">
                ...
                <div class="modal-footer">
                    <button style="width: 100%" id='btnfechamento' type="button" data-dismiss="modal" class="btn btn-success font-weight-bold">Confirmar</button>
                </div>
    ...
    <div class="modal fade" id="modal-clientenovo" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group validated col-lg-6 col-md-6 col-sm-10">
                                    ...
                                    <select class="custom-select form-control" id="cidadeid" name="cidade">
                                ...
                                <div class="form-group validated col-sm-8 col-lg-3">
                                    <label class="col-form-label">Celular/Telefone</label>
                                    <div class="">
