								   ...
								   <div class="form-group col-lg-4 col-md-4 col-sm-6">
										...
										<div class="input-group">
											...
											<select class="form-control select2" id="kt_select2_3" name="cliente" >
												...
												@if($config->ambiente == 0)
												    <option value="{{$c->id}}">{{$c->id}} - {{$c->razao_social}} ({{$c->cpf_cnpj}})</option>
												@else
												    <option value="{{$c->id}}">{{$c->id}} - {{$c->nome_fantasia}} ({{$c->cpf_cnpj}})</option>
												@endif
												@endforeach
											</select>
									...
									<div class="form-group col-lg-4 col-md-4 col-sm-6">
									<label class="col-form-label" id="">Data Venda</label>
									   <div class="">
								           <div class="input-group date">
											<input type="text" name="datavenda" class="form-control" id="kt_datepicker_1"  type="date"  />
												...
												<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
													...
													<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
														...
														<div class="row">
																...
																<a id="addProdnaocadastro" href="#!" style="width: 30%;" class="btn btn-light-success">
																	<i class="la la-check"></i>
																	Inserir Produto não Cadastrado(Orçamento)
																</a>
															</div>
														</div>
														<!-- Fim da tabela -->
...
<div class="modal fade" id="modalclientedestino" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">INFORME O CLIENTE DESTINO DOS PRODUTOS</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			<div class="modal-body">
                ...
                <div class="form-group validated col-sm-12 col-lg-12 col-12">
					...
					@endforeach
						...
						<label class="col-form-label">Orçamento</label>
						<div class="">
						    <input id="orcamento" type="text" class="form-control @if($errors->has('orcamento')) is-invalid @endif">
...
<div class="modal fade" id="modalprodutonaocadastrado" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">INFORME DADOS DO PRODUTO</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			<div class="modal-body">
                ...
                <div class="form-group validated col-sm-12 col-lg-12 col-12">
						...
						<div class="">
						    <input focus id="nomeproduto" type="text" class="form-control @if($errors->has('nomeproduto')) is-invalid @endif">

					    </div>

						<label class="col-form-label">Quantidade</label>
						<div class="">
						    <input type="text" name="quantidadenao" class="form-control" value="0" id="quantidadenao"									 />
						...
						<div class="">
						    ...
						    <input type="text" name="valornao" class="form-control money" value="0" id="valornao" />
			...
			<div class="modal-footer">
				<button style="width: 100%" type="submit" id = "incluirproduto" data-dismiss="modal" class="btn btn-success font-weight-bold">Incluir</button>
			</div>
		</div>
	</div>
</div>
