									...
									<div class="row">
												...
												<table class="datatable-table" style="max-width: 100%; overflow: scroll">
													<thead class="datatable-head">
														<tr class="datatable-row" style="left: 0px;">
															...
															<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">NF-e</span></th>
															<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">NFc-e</span></th>
															...
															<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 280px;">Ações teste</span></th>
														</tr>
													</thead>
													...
													<tbody id="body" class="datatable-body">
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell"><span class="codigo" style="width: 100px;" id="numeroNf">{{ $v->NFcNumero > 0 ? $v->NFcNumero : '--' }}</span>
															</td>
															...
															<td>
																<div class="row">
																	<span style="width: 280px;">
																		@if($v->estado == 'DISPONIVEL' || $v->estado == 'CANCELADO' )
																		<a title="Informações Adicionais da NFE" onclick="modalinfnfe({{$v->id}})" class="btn btn-primary">
																			<i class="la la-comment"></i>
																		</a>


																		<a class="btn btn-danger" onclick='swal("Atenção!", "Deseja cancelar essa venda?", "warning").then((sim) => {if(sim){ location.href="/vendas/delete/{{ $v->id }}" }else{return false} })' href="#!">
																		...
																		<a title="CUPOM FISCAL" target="_blank" href="/nfce/imprimirvenda/{{$v->id}}" class="btn btn-success">
																		...
																		<a title="Cancelar NFC-e" href="#!" onclick="modalCancelar({{$v->id}})" class="btn btn-warning ">
																		...
																		<!--<a title="gerarteste" target="_blank" href="/nf/gerarNf/{{$v->id}}" class="btn btn-danger">
																		      <i class="la la-download"></i>
																	       </a> -->
										...
										<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
											...
											<div class="row" style="margin-top: 5px;">
												...
												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-danfe" target="_blank" style="width: 100%" class="btn btn-primary">Simular Danfe</a>
												</div>
...
<div class="modal fade" id="modalnfce" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">INUTILIZAÇÃO DE NÚMERO(s) DE NFC-e </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-6 col-Numero NF Inicial-6">
						<label class="col-form-label" id="">Numero NFC-e Inicial</label>
						<div class="">
							<input type="text" id="nInicionfce" placeholder="" name="nInicio" class="form-control" value="">
						</div>
					</div>
					<div class="form-group validated col-sm-6 col-lg-6">
						<label class="col-form-label" id="">Numero NFC-e Final</label>
						<div class="">
							<input type="text" id="nFinalnfce" placeholder="" name="nFianal" class="form-control" value="">
						</div>
					</div>
					<div class="form-group validated col-sm-12 col-lg-12">
						<label class="col-form-label" id="">Justificativa</label>
						<div class="">
							<input type="text" id="justificativa_inutnfce" placeholder="" name="justificativa" class="form-control" value="">
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Fechar</button>
				<button type="button" id="btn-inut-3" onclick="inutilizarnfce()" class="btn btn-light-success font-weight-bold spinner-white spinner-right">Inutilizar</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modalcancelarnfce" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-12 col-lg-12 col-12">
						<label class="col-form-label" id="">Justificativa</label>
						<input type="text" placeholder="Justificativa" id="justificativanfce" name="justificativa" class="form-control" value="">
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Fechar</button>
				<button type="button" id="btn_cancelar_nfce" onclick="cancelarnfce()" class="btn btn-light-info font-weight-bold spinner-white spinner-right">Cancelar</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modalinf" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Informações do NF</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-12 col-lg-12 col-12">
						<label class="col-form-label" id="">Informações do NF</label>
						<input type="text" placeholder="Observação" id="infnfe" class="form-control">
					</div>
				</div>

			</div>
			<div class="modal-footer">
				<button type="subit" id="salvar" onclick="atualizarinfvenda()" class="btn btn-success font-weight-bold spinner-white spinner-right">Salvar</button>
