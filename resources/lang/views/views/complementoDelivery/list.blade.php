		...
		<div class="">
			...
			<div class="col-12">
				...
				<a href="/deliveryComplemento/new" class="btn btn-lg btn-success">
					<i class="fa fa-plus"></i>Novo Adicional/Complemento de Delivery
				</a>
				<a href="/categoriasAdicional" class="btn btn-lg btn-info">
					<i class="fa fa-list"></i>Categorias de adicional
				</a>
			</div>
		</div>
		<br>
					...
					<div class="card card-custom gutter-b card-stretch" style="height: 200px;">
						...
						<div class="card-body pt-4">
							...
							<p class="text-muted font-weight-bold">Valor: 
								<strong class="text-info">R$ {{$c->valor}}</strong>
							</p>
							<p class="text-muted font-weight-bold">Categoria: 
								<strong class="text-info">{{$c->categoria->nome}}</strong>
							</p>
							<!--end::Info-->
