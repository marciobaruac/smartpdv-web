					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
										...
										<ul class="navi navi-hover">
											...
											<li class="navi-item">
												...
												<a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/servicos/delete/{{ $c->id }}" }else{return false} })' href="#!" class="navi-link">
													<span class="navi-text">
							...
							<div class="card-body">
								...
								<div class="kt-widget__info">
									<span class="kt-widget__label">Comissão:</span>
									<a target="_blank" class="kt-widget__data text-success">{{ $c->comissao }}</a>
								</div>
