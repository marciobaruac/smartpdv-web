		...
		<div class="">
			...
			<div class="col-sm-12 col-lg-4 col-md-6 col-xl-4">
				...
				<a href="/deliveryProduto/new" class="btn btn-lg btn-success">
					<i class="fa fa-plus"></i>Novo Produto de Delivery
				</a>
			</div>
		</div>
		<br>
					...
					<div class="card card-custom gutter-b card-stretch">
						...
						<div class="card-body pt-4">
								...
								<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" >
									...
									<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
										...
										<ul class="navi navi-hover">
											...
											<li class="navi-item">
												<a href="/deliveryProduto/adicionais/{{ $p->id }}" class="navi-link">
													<span class="navi-text">
														<span class="label label-xl label-inline label-light-warning">Adicionais</span>
													</span>
												</a>
											</li>
							...
							<div class="d-flex align-items-end mb-7">
								...
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column">
										<a class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">{{$p->id}} - {{$p->produto->nome}}</a>
							...
							<div class="mb-7">
								...
								<div class="d-flex justify-content-between align-items-center">
									<span class="text-dark-75 font-weight-bolder mr-2">Ativo no delivery:</span>
									<span class="text-danger">
