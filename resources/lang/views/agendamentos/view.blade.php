	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-body" style="height: 500px; overflow-y: auto;">
				<div class="row">
					<div class="form-group validated col-sm-9 col-lg-9 col-9 novo-cliente">
					...
					<div style="display:none;" class="form-group validated col-sm-9 col-lg-9 col-9 cliente-cad">
						<label class="col-form-label" id="">Cliente novo selecionado</label><br>
						<input id="cli_novo" readonly="" disabled="" class="form-control" type="text" name="nome">

						<input type="hidden" value="0" id="cli_novo_id" name="cliente_id">
					</div>
					<div class="col-sm-3 col-lg-3 col-3 novo-cliente"><br><br>
						<a onclick="openModalCliente()" class="btn btn-success">
							<i class="la la-plus"></i>
						</a>
					</div>
