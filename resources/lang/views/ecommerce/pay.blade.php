    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        <li class="active" data-filter=".cartao">Cartão de Crédito</li>
                        <li data-filter=".pix">PIX</li>
                        <li data-filter=".boleto">Boleto</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row featured__filter">
            ...
            <div class="col-12 mix cartao">
                ...
                <form action="/ecommerce/paymentCard" method="post" id="paymentForm">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-6">
                            <div class="checkout__input">
                                ...
                                <select class="form-control" style="width: 100%; height: 45px;" id="docType" data-checkout="docType">
                                </select>
                            </div>
                        </div>
                ...
                <form action="/ecommercePay/boleto" method="post" id="paymentFormBoleto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-6">
                            <div class="checkout__input">
                                <p>Tipo de documento<span></span></p>
                                <select name="docType" class="form-control" style="width: 100%; height: 45px;" data-checkout="docType">
                                    <option @if(strlen($cliente->cpf) == 14) selected @endif value="CPF">CPF</option>
                                    <option @if(strlen($cliente->cpf) == 18) selected @endif value="CNPJ">CNPJ</option>
                                </select>
                            </div>
                        </div>
