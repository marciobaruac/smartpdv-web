									...
									<table class="datatable-table" style="max-width: 100%; overflow: scroll">
										<thead class="datatable-head">
											<tr class="datatable-row" style="left: 0px;">
												...
												<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 350px;">Ações</span></th>
											</tr>
										</thead>
											...
											<tr class="datatable-row">
												...
												<td class="datatable-cell">
													<span class="codigo" style="width: 350px;">
														...
														<a title="alterar senha" class="btn btn-sm btn-info" href="/clientesDelivery/alterarSenha/{{ $c->id }}">
														...
														@if($c->ativo)
														<a class="btn btn-sm btn-danger" title="Status" href="/clientesDelivery/alterarStatus/{{ $c->id }}">
															<i class="las la-times"></i>				
														</a>
														@else
														<a class="btn btn-sm btn-success" title="Status" href="/clientesDelivery/alterarStatus/{{ $c->id }}">
