...
Route::group(['prefix' => 'pedidoProduto'],function(){
	...
	Route::get('/dividePizza', 'ProdutoRestController@dividePizza');
	Route::get('/all', 'ProdutoRestController@all');
	Route::get('/categorias', 'ProdutoRestController@categorias');
...
Route::group(['prefix' => 'pedidos'],function(){
	...
	Route::get('/autenticaUsuario', 'PedidoRestController@autenticaUsuario');
	Route::get('/addItens', 'PedidoRestController@addItens');
	Route::get('/fecharComanda', 'PedidoRestController@fecharComanda');
	Route::get('/senhaParaAcesso', 'PedidoRestController@senhaParaAcesso');
