...
$('#salvar-notacomplementar').click(() => {
	...
	let tipo = $('#tipo').val();
	let frete = $('#frete').val();
	let transportadora = $('#kt_select2_2').val();
	...
	$.post(path+'notacomplementar/salvar', {_token: token, data: data})
	.done((success) => {
		console.log(success)
...
function sucesso(){
	...
	setTimeout(() => {
		location.href = path+'notacomplementar';
	}, 4000)
}
