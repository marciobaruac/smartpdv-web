...
//  let dif = (valorVenda - valorCompra)/valorCompra*100;
  ...
  let dif = (valorVenda - valorCompra)/valorVenda*100;
  
  let vlucro = formatReal(dif)
  
  vlucro = vlucro.replace('.','')
  vlucro = vlucro.substring(3, vlucro.length)
...
//$('#flucro').keyup(() => {
  ...
  //let vcusto = parseFloat($('#valor_compra').val().replace(',', '.'));
//  let vlucro = parseFloat($('#flucro').val().replace(',', '.'));


//  if(vcusto > 0 && vlucro >  0) {
 //    let vprecovenda =  vcusto + ((vcusto/100) * vlucro)
//     vprecovendas = formatReal(vprecovenda)
//     vprecovendas = vprecovendas.replace('.','')
 //    vprecovendas = vprecovendas.substring(3, vprecovendas.length)
//     $('#valor_venda').val(vprecovendas)
//  }
 // else {
 //   $('#valor_venda').val('0')
//  }
  ...
  //saida.innerHTML += `<h2>Contando de 0 até ${vprecovenda}</h2>`
