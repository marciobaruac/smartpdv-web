...
class UsuarioController extends Controller
{
	...
	public function save(Request $request){
		...
		$result = Usuario::create([
			...
			'acesso_inicial_pdv' => $request->acesso_inicial_pdv ? true : false,
			'acesso_cancelamento_venda' => $request->acesso_cancelamento_venda ? true : false,
	...
	public function update(Request $request){
		...
		$usr->acesso_inicial_pdv = $request->acesso_inicial_pdv ? true : false;
		$usr->acesso_cancelamento_venda = $request->acesso_cancelamento_venda ? true : false;
