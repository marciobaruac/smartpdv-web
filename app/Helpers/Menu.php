...
class Menu {
	...
	public function __construct(){
		$this->menu = [
			...
			[
				...
				'subs' => [
					[
						'nome' => 'Entrada com Nota Baixada da Sefaz',
						'rota' => '/dfe'
					],
					[
						'nome' => 'Entrada com XML',
						'rota' => '/compraFiscal'
					],
					[
						'nome' => 'Entrada Manual',
			...
			[
				...
				'subs' => [
                    ...
                    [
						'nome' => 'Saida Interna',
						'rota' => '/vendas/novatransferencia'
					],
					[
						'nome' => 'Nova Simples Remessa',
						'rota' => '/vendas/novasimplesremessa'
					],
				//	[
				...
				//	],
					...
					[
						'nome' => 'Nota Complementar',
						'rota' => '/notacomplementar'
					]
				]
			],
			[
	...
	public function preparaMenu(){
	    ...
	    $permissoesAtivas = json_decode($usuario->ativo);

    	//$permissoesAtivas = [$usuario->ativo,$usuario->acesso_cliente,$usuario->acesso_fornecedor,$usuario->acesso_financeiro];
