...
class DevolucaoService{
	...
	public function gerarDevolucao($devolucao,$nfnumero){
		...
		$stdICMSTot->vBCST = $devolucao->totalicmsst;;
		$stdICMSTot->vST = $devolucao->totalbaseicmsst;
		...
		if($devolucao->vFrete){
			$stdICMSTot->vNF = 
			$this->format(($somaProdutos+$devolucao->totalbaseicmsst));
		} 
		else $stdICMSTot->vNF = $this->format($somaProdutos+$devolucao->totalbaseicmsst-$devolucao->vDesc);
	...
	//	$stdTransp = new \stdClass();
		...
		$stdTransp = new \stdClass();
		$stdTransp->modFrete = $devolucao->frete->tipo ?? '9';
