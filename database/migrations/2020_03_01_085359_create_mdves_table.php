...
class CreateMdvesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mdves', function (Blueprint $table) {
            ...
            // alter table mdves add column produto_pred_nome varchar(50) default '';
            // alter table mdves add column produto_pred_ncm varchar(8) default '';
            // alter table mdves add column produto_pred_cod_barras varchar(13) default '';
            // alter table mdves add column cep_carrega varchar(9) default '';
            // alter table mdves add column cep_descarrega varchar(9) default '';
            // alter table mdves add column tp_carga varchar(2) default '';
